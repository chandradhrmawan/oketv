...
$config['xml_data']       = "/mainData/data/xml";
// $config['xml_data_new'] = "/mainData/data/xml/";
$config['images_path']    = "/mainData/data/okezone.tv/images";

//$config['images_uri']         = "http://cdn.okezone.tv";
$config['images_uri']           = "http://a.okezone.com";
$config['image_uri']            = "https://img.okezone.com/";
...
//$config['video_url']      = 'http://video.okezone.com';

$config['domain_uri']     = '/mainData/sites2/newtrunks/trunks/sitemap/site_domain.php';
$config['domain_uri_new'] = '/trunks/sitemap/site_domain.php';

$config['domain_uri_multimedia']     = '/mainData/sites2/newtrunks/trunks/sitemap/site_domain_multimedia.php';
$config['domain_uri_multimedia_new'] = '/trunks/sitemap/site_domain_multimedia.php';

$config['pl_headline_id'] = 51;
$config['featured_id']    = 45721;
$config['json_data']      = '/mainData/data/okezone.tv/json';
