  ...
  <div class="container">
    <div class="content">
      <div id="tv-wrap" class="tv-wrap clearfix">
        <div class="tv-live" style="height: auto;">
          <div class="tv-live-frame">
            <?php foreach ($radio_channel as $key => $channel) : ?>
              <iframe name="someFrame" id="someFrame" src="<?php echo base_url() ?>radio/embed/<?php echo $key ?>" style="height: 200px;" frameborder="0" allowfullscreen></iframe>
              <?php break ?>
            <?php endforeach ?>
          </div>
        </div>
        <div class="tv-list-wrap">
          <div class="tv-title">
            <p>Radio</p>
            <span>Showing <?php echo count($radio_channel) ?> videos</span>
          </div>
