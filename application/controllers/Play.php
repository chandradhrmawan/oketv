...
class Play extends CI_Controller
{
  ...
  {
    $infographic_content['infografis']            = array_chunk($this->infografis['attributes'], 3);
    ...
    $latest_video_content['latest_videos']        = array_chunk(array_slice($this->video_headline, 10, 12), 3);
    ...
    $content['main_content'] = $this->load->view('content/vbase_play', $main_content, TRUE);
  ...
  public function get_mobile()
  {
    ...
    $content['main_content'] = $this->load->view('content_mobile/vbase_play', $main_content, TRUE);
